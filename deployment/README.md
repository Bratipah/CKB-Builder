...
offckb deploy --network devnet --target <contract-binary-path> --output /home/user/Documents/web3/CKB/ckb-intro/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /home/user/Documents/web3/CKB/ckb-intro/deployment
```
